        ...
        <div class="page-title mb-3">
            <div class="row align-items-center flex-md-row flex-column-reverse">
                <div class="col-12 col-md-6 d-flex align-items-center gap-3">
                    ...
                    <h3 class="mb-0">Detail Jenis Produk</h3>
                </div>
                ...
                <div class="card-body">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <p class="fs-6 mb-0">{{ $productType->name }}</p>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Dibuat pada</h6>
                            <p class="fs-6 mb-0">{{ $productType->created_at?->format('d F Y, H:i') }}</p>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Diperbarui pada</h6>
                            <p class="fs-6 mb-0">{{ $productType->updated_at?->diffForHumans() }}</p>
                        </div>
                    </div>

                    <div class="d-flex justify-content-end mt-4 gap-2">
                        <a href="{{ route('product-types.index') }}" class="btn btn-light-secondary">Kembali</a>
                        <a href="{{ route('product-types.edit', $productType) }}" class="btn btn-primary">Ubah</a>
                    </div>
                </div>
            </div>
        </section>
