        ...
        <section class="section mt-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Kode Produk</h6>
                            <p class="fs-6 mb-0">{{ $product->code }}</p>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Nama Produk</h6>
                            <p class="fs-6 mb-0">{{ $product->name }}</p>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Jenis Produk</h6>
                            <p class="fs-6 mb-0">{{ $product->productType?->name }}</p>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Unit</h6>
                            <p class="fs-6 mb-0">{{ $product->unit?->name }}</p>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">HS Code</h6>
                            <p class="fs-6 mb-0">{{ $product->hs_code ?? '—' }}</p>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Dibuat pada</h6>
                            <p class="fs-6 mb-0">{{ $product->created_at?->format('d F Y, H:i') }}</p>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Diperbarui pada</h6>
                            <p class="fs-6 mb-0">{{ $product->updated_at?->diffForHumans() }}</p>
                        </div>
                    </div>

                    <div class="d-flex justify-content-end mt-4 gap-2">
                        <a href="{{ route('products.index') }}" class="btn btn-light-secondary">Kembali</a>
                        <a href="{{ route('products.edit', $product) }}" class="btn btn-primary">Ubah</a>
                    </div>
                </div>
            </div>
        </section>
