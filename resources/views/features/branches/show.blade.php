        ...
        <div class="page-title mb-3">
            <div class="row align-items-center flex-md-row flex-column-reverse">
                <div class="col-12 col-md-6 d-flex align-items-center gap-3">
                    ...
                    <h3 class="mb-0">Detail Cabang</h3>
                </div>
        ...
        <section class="section mt-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Nama Cabang</h6>
                            <p class="fs-6 mb-0">{{ $branch->branch_name }}</p>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Lokasi</h6>
                            <p class="fs-6 mb-0">{{ $branch->location }}</p>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Jumlah Pengguna</h6>
                            <p class="fs-6 mb-0">{{ $branch->users_count }} pengguna</p>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Dibuat pada</h6>
                            <p class="fs-6 mb-0">{{ $branch->created_at?->format('d F Y, H:i') }}</p>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted">Diperbarui pada</h6>
                            <p class="fs-6 mb-0">{{ $branch->updated_at?->diffForHumans() }}</p>
                        </div>
                    </div>

                    <div class="d-flex justify-content-end mt-4 gap-2">
                        <a href="{{ route('branches.index') }}" class="btn btn-light-secondary">Kembali</a>
                        <a href="{{ route('branches.edit', $branch) }}" class="btn btn-primary">Ubah</a>
                    </div>
                </div>
            </div>
        </section>
