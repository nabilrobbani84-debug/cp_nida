    ...
    <div class="page-heading">
        <div class="page-title mb-3">
            <div class="row align-items-center flex-md-row flex-column-reverse">
                <div class="col-12 col-md-6 d-flex align-items-center gap-3">
                    ...
                    <h3 class="mb-0">Input Produksi Harian</h3>
                </div>
        ...
        <section class="section mt-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <form action="{{ route('branch-productions.store') }}" method="post">
                        @csrf
                        @include('features.branch-productions.partials._form', [
                            'products' => $products,
                            'branchName' => $branchName,
                        ])

                        <div class="d-flex justify-content-end mt-4 gap-2">
                            <a href="{{ route('branch-productions.index') }}" class="btn btn-light-secondary">Batal</a>
